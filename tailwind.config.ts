    ...
    extend: {
      colors: {
        ...
        taxi: {
          ...
          "gold-dark": "hsl(var(--taxi-gold-dark))",
          charcoal: "hsl(var(--taxi-charcoal))",
          slate: "hsl(var(--taxi-slate))",
          glass: "hsl(var(--taxi-glass))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(45, 100%, 51%, 0.2)" },
