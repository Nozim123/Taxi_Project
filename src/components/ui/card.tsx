...
const cardVariants = cva("rounded-2xl text-card-foreground", {
  variants: {
    variant: {
      ...
      "glass-hover":
        "bg-card/60 backdrop-blur-xl border border-border/50 shadow-card transition-all duration-300 hover:border-primary/30 hover:scale-[1.02] hover:shadow-glow",
    },
  },
  defaultVariants: {
    variant: "default",
